...
"""
  ...
  Testfunctions:
   ...
   The places for testing purposes
       ...
       >>> x1 = [[1, 4, 5], [2, 2, 2], [1, 1.5, 0.3], [2, 5, 7], [1, 0, 0]]
  ...
  Now calculates some things in parallel:
  But first serial variant (from python) , just for comparing:

      # >>> map(cos, x5)
      # [0.54030230586813977, -0.41614683654714241, -0.98999249660044542, -0.65364362086361194, 0.28366218546322625]
   ...
   For one of the own functions, taking lists and giving some back two.
