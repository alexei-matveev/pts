...
def main(argv):
    ...
    containing   direct  internal   geometry   coordinates  with   the
    requirement of the remaining input in separate user readable files
    (requires the  option --symbols, sometimes  also --zmatrix, --mask
    or --abscissa).
